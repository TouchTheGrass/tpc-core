...
class SessionService:
    ...
    def create_game_session(self, first_player: PlayerModel, session_rule="base") -> GameSessionEntity:
        ...
        if session_rule == "base":
            ...
            session = GameSessionModel.objects.create(status=GameSessionStatus.WAIT, rules={"board_form":"quadrangular",\
                                                                                            "victory_condition":"first_checkmate",
                                                                                            "timer":False,})
            game_session_enity=GameSessionEntity(status=GameSessionStatus.WAIT,\
                                                 rules={"board_form":"quadrangular", "victory_condition":"first_checkmate", "timer":False}, id=session.id)
