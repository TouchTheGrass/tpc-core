...
class TestChessEngine(unittest.TestCase):
    ...
    def test_QUEEN_move(self):
        ...
        allowed_moves = ['A4', 'B4', 'C4', 'D3', 'E4', 'F4', 'G4', 'H4', 'D5', 'D6','B6','J6','C5','I5','C3','E3','F10','E9']  #,
    ...
    def test_upgrade_pawn(self):
        ...
        self.assertEqual(self.chess_engine.make_move('F2', 'F1'), [self.chess_engine.board[coord],\
    ...
    def test_check_check_and_checkmate(self):
        ...
        self.assertEqual(self.chess_engine.check_check_and_checkmate(PieceColor.RED), 1)
        self.chess_engine.make_move('E1','E2')
        self.assertEqual(self.chess_engine.check_check_and_checkmate(PieceColor.RED), 0)
        self.chess_engine = Board(pos_check_and_checkmate)
        self.assertEqual(self.chess_engine.check_check_and_checkmate(PieceColor.RED), 2)
